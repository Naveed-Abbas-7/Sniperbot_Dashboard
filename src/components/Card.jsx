...
export function Card({ image, heading, sub_text, ...props }) {
  ...
  return (
    <div className="flex flex-col w-full 2xl:text-[20px] text-[16px] gap-4 border font-poppins rounded-2xl border-black py-3 pl-2 ml-3 pr-2 shadow-md shadow-pink-700  ">
